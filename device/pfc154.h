/*
  pfc154.h: FUSE and Register Definitions for the Padauk PFC154 device.
...
#ifndef __PDK_DEVICE_PFC154_H__
#define __PDK_DEVICE_PFC154_H__

#if !defined(__PDK_DEVICE_XXX_H__)
	#define __PDK_DEVICE_XXX_H__ "pfc154.h"
#else
	#error "Attempt to include more than one "pdk/device/XXX.h" file."
#endif

#if !defined(__SDCC_pdk14)
	#error "PFC154 needs the PDK14 backend. You must compile with the -mpdk14 option."
#endif

#define ILRC_FREQ           66000
