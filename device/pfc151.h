/*
  pfc151.h: FUSE and Register Definitions for the Padauk PFC151 device.
...
#ifndef __PDK_DEVICE_PFC151_H__
#define __PDK_DEVICE_PFC151_H__

#if !defined(__PDK_DEVICE_XXX_H__)
	#define __PDK_DEVICE_XXX_H__ "pfc151.h"
#else
	#error "Attempt to include more than one "pdk/device/XXX.h" file."
#endif

#if !defined(__SDCC_pdk14)
	#error "PFC151 needs the PDK14 backend. You must compile with the -mpdk14 option."
#endif
