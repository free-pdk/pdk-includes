...
#if defined(__PDK___PDK_HAS_PORTB)
  #define INTEN_PB0_ENABLE_BIT         1
  #define INTEN_PB0                    (1 << INTEN_PB0_ENABLE_BIT)
#endif
#if defined(__PDK___PDK_HAS_PB5_PA4_INT)
...
#endif
#if defined(__PDK___PDK_HAS_COMP_INT_EDGE)
